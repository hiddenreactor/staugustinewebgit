...
<head>
    ...
    <link rel="icon" type="image/png" href="/staugustine/assets/img/st/favicon2.png" />
    ...
    <link rel="stylesheet" href="/staugustine/assets/css/bootstrap.css">
    <link rel="stylesheet" href="/staugustine/assets/css/default.css">
    <link rel="stylesheet" href="/staugustine/assets/css/default-responsive.css">
...
<script>
    ...
    <!--<script>// scroller Horizaontal by mouse coord starts
        $(document).ready(function() {
...
<section class="parallax-1">
        <div class="parallax-inner">
                ...
                <div id="scroll_wrapper">
                    ...
                    <div class="item">
                        <p><a href="http://faithandfoundation.com/stories/retreat.html"><img src="assets/img/content/events/holyretreat.JPG" alt="" ></a></p>
                    </div>
                    <div class="item">
